...
def plot_tvb():
    ...
    sub_ez_regions = {
        'id008gc': ['Right-Amygdala', 'Right-Hippocampus',
                    #                                'ctx-rh-medialorbitofrontal'
                    ],
        'id013pg': ['ctx-rh-fusiform']
    }
    sub_pz_regions = {
        'id008gc': ['ctx-rh-inferiortemporal',
                    'ctx-rh-temporalpole', ],
        'id013pg': ['Right-Hippocampus', 'Right-Amygdala',
    ...
    for subject in SUBJECTS:
        ...
        electrodes_path = BIDSPath(
            ...
            suffix='electrodes', datatype='ieeg',
        ...
        resected_chs = [ch for idx, ch in enumerate(elec_names) if elec_regions[idx] in ez_regions]
        pz_resected_chs = [ch for idx, ch in enumerate(elec_names) if elec_regions[idx] in pz_regions]
