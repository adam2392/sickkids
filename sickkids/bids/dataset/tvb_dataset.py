...
def _set_ch_types_tvb(raw, subject):
    ...
    if subject == 'id013pg':
        bads = ['A3', 'A8', 'A9', 'A10', 'A11', 'A12', 'A13', 'A14', 'A15',
                'B1', 'B2', 'B3', 'B4', 'B8', 'B9', 'B13', 'B14', 'B15',
                'TB1', 'C7', 'C8', 'C9', 'C10', 'OT1', 'OP1', 'PI1']
        ...
        annot = mne.annotations_from_events(events, raw.info['sfreq'], event_desc,
                                            orig_time=raw.info['meas_date'])
        raw.set_annotations(annot)
    elif subject == 'id008gc':
        bads = ['R1', 'CR1', 'FD1', 'CC1', 'OR1', 'OR8', 'OR9', 'TP1', 'TP2',
                'A3', 'B1', 'B9', 'B10', 'GPH1', 'T1']
        raw.info['bads'].extend(bads)
