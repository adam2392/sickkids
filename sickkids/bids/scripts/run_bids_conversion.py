...
import numpy as np
import pandas as pd
from eztrack.preprocess.bids_conversion import append_original_fname_to_scans, _update_sidecar_tsv_byname
...
def write_edf_to_bids(edf_fpath: [str, Path],
                      ...
                      line_freq: int = 60, montage=None,
                      dataset_name=None, source_dir=None) -> Dict:
    ...
    for subject in subject_ids:
        ...
        for run_id, fpath in enumerate(source_paths):
            ...
            output_dict = write_edf_to_bids(edf_fpath=fpath,
                                            ...
                                            montage=montage, dataset_name='tvb')
